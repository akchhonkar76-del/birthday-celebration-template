    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Shagun</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Shagun's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Ankit 💖</h2>
          <p className="final-subtitle">I love you so muchhh ✨</p>
        </section>
      </div>
